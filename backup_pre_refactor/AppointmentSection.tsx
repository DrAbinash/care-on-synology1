            ...
            <div style={{ display: "flex", gap: ".75rem", flexWrap: "wrap" }}>
              ...
              {config?.gateway === "icici" ? (
                ...
                >
                  {paying ? (
                    <>
                      <Loader2 size={18} style={{ animation: "spin 1s linear infinite" }} /> Redirecting to Orange Pay…
                    </>
                  ) : (
                    <>
                      <img
                        src="/icici-bank-logo.jpeg"
                        alt="ICICI Bank"
                        style={{
                          height: "36px",
                          objectFit: "contain",
                      ...
                      />
                      <span>Pay ₹{total.toLocaleString("en-IN")} by ICICI Bank</span>
                    </>
                  )}
                </button>
              ) : (
