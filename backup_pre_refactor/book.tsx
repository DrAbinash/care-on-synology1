      ...
      <div className="container-narrow" style={{ padding: "2rem 1rem 4rem", maxWidth: 920 }}>
        ...
        {step === 3 ? (
          ...
          <div style={{ maxWidth: 640, margin: "0 auto" }}>
            <div style={cardStyle}>
              {/* Supported payment methods logos at the top, spanning horizontal width */}
                  ...
                  config?.gateway === "icici" ? (
                    ...
                    >
                      {paying ? (
                        ...
                        <>
                          <img src="/icici-bank-logo.jpeg" alt="ICICI Bank" style={{ height: "36px", objectFit: "contain", background: "white", borderRadius: "6px", padding: "2px", border: "2px solid #002F6C" }} />
                          <span>Pay {fmt(total)} by ICICI Bank</span>
                        </>
                      )}
                    </button>
                  ) : (
