...
export const DEFAULT_QUICK_SELECT_TILES: QuickSelectTile[] = [
  ...
  t("findings","Normal ventricles","Ventricular system and cisternal spaces are normal in size and configuration. No midline shift.",{mnemonic:"nv",scopeModality:"MR",scopeBodyPart:"Brain",favorite:true,conflictGroup:"ventricles",impressionSentence:"Ventricles and cisternal spaces are normal. No hydrocephalus."}),
