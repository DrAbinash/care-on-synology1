...
export const DEFAULT_QUICK_SELECT_TILES: QuickSelectTile[] = [
  ...
  t("technique","MRI 1.5T standard","MRI performed on 1.5T scanner. Sequences: T1W, T2W, FLAIR, DWI, ADC, post-contrast T1W GRE. Slice thickness 5 mm.",{mnemonic:"m1",scopeModality:"MR"}),
  t("technique","MRI LS Spine","MRI lumbo-sacral spine on 1.5T. Sagittal T1W, T2W; axial T1W, T2W. Slice thickness 4 mm.",{mnemonic:"ml",scopeModality:"MR",scopeBodyPart:"LS Spine"}),
