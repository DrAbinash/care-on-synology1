...
export const DEFAULT_QUICK_SELECT_TILES: QuickSelectTile[] = [
  ...
  t("findings","Normal ventricles","Ventricular system and cisternal spaces are normal in size and configuration. No midline shift.",{mnemonic:"nv",scopeModality:"MR",scopeBodyPart:"Brain",favorite:true,conflictGroup:"ventricular",baselineReplaces:"Ventricular system and cisternal spaces are normal in size and configuration. No midline shift.",impressionSentence:"Ventricles and cisternal spaces are normal. No hydrocephalus."}),
  t("findings","Hydrocephalus","The ventricular system is dilated, consistent with hydrocephalus. No midline shift.",{mnemonic:"hc",scopeModality:"MR",scopeBodyPart:"Brain",category:"abnormal",conflictGroup:"hydrocephalus",baselineReplaces:"Ventricular system and cisternal spaces are normal in size and configuration. No midline shift.",impressionSentence:"Hydrocephalus."}),
  t("findings","Glioma recurrence","Heterogeneously enhancing area in the right frontal operculum at the post-resection cavity, measuring approximately ___ × ___ × ___ cm, with surrounding T2/FLAIR hyperintensity suggestive of edema. Findings are concerning for tumor recurrence.",{mnemonic:"gr",scopeModality:"MR",scopeBodyPart:"Brain",category:"abnormal",favorite:true,conflictGroup:"tumor recurrence"}),
  t("findings","Acute infarct (DWI)","Restricted diffusion in the {side} MCA territory on DWI/ADC, consistent with acute infarct. No hemorrhagic transformation.",{mnemonic:"ai",scopeModality:"MR",scopeBodyPart:"Brain",category:"critical",anatomicalSection:"mca",conflictGroup:"infarct",properties:"side",impressionSentence:"Acute {side} MCA territory infarct."}),
  t("findings","Basal ganglia hemorrhage","Acute intraparenchymal hemorrhage in the {side} basal ganglia with intraventricular extension. Mass effect with midline shift of ___ mm.",{mnemonic:"ah",scopeModality:"MR",scopeBodyPart:"Brain",category:"critical",anatomicalSection:"basal ganglia",conflictGroup:"hemorrhage",properties:"side",impressionSentence:"Acute {side} basal ganglia hemorrhage."}),
  t("findings","Acute hemorrhage","Acute intraparenchymal hemorrhage in the {side} basal ganglia with intraventricular extension. Mass effect with midline shift of ___ mm to the contralateral side.",{mnemonic:"ah2",scopeModality:"MR",scopeBodyPart:"Brain",category:"critical",anatomicalSection:"basal ganglia",conflictGroup:"hemorrhage",properties:"side",impressionSentence:"Acute {side} basal ganglia hemorrhage."}),
  t("findings","Fazekas 1","Few punctate T2/FLAIR hyperintense white matter lesions in bilateral periventricular and deep white matter, Fazekas grade 1. No confluent lesions.",{mnemonic:"f1",scopeModality:"MR",scopeBodyPart:"Brain",category:"abnormal",conflictGroup:"fazekas",impressionSentence:"Mild chronic small vessel ischemic disease (Fazekas grade 1)."}),
  t("findings","Fazekas 2","Confluent T2/FLAIR hyperintense white matter lesions in bilateral periventricular and deep white matter, Fazekas grade 2.",{mnemonic:"f2",scopeModality:"MR",scopeBodyPart:"Brain",category:"abnormal",conflictGroup:"fazekas",impressionSentence:"Moderate chronic small vessel ischemic disease (Fazekas grade 2)."}),
  t("findings","Orbital cellulitis","Preseptal and postseptal inflammatory change in the {side} orbit, consistent with orbital cellulitis.",{mnemonic:"oc",scopeModality:"MR",scopeBodyPart:"Brain",category:"abnormal",conflictGroup:"orbital",properties:"side",impressionSentence:"{side} orbital cellulitis."}),
  t("findings","Normal LS spine","Lumbar vertebrae show normal alignment and marrow signal. No spondylolisthesis. Disc spaces maintained.",{mnemonic:"nl",scopeModality:"MR",scopeBodyPart:"LS Spine",favorite:true,conflictGroup:"spondylolisthesis",baselineReplaces:"No spondylolisthesis."}),
  t("findings","Disc herniation L4-L5","Broad-based disc bulge at L4-L5 with posterocentral-right paracentral protrusion causing indentation on the thecal sac and mild narrowing of bilateral neural foramina. No significant central canal stenosis.",{mnemonic:"dh",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",favorite:true,conflictGroup:"disc bulge",impressionSentence:"Disc herniation at L4-L5 causing indentation on the thecal sac."}),
  t("findings","Disc bulge L3-L4","Disc bulge at L3-L4 without nerve root compression.",{mnemonic:"db34",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"disc bulge"}),
  t("findings","Disc protrusion L5-S1","Posterocentral disc protrusion at L5-S1 indenting the thecal sac.",{mnemonic:"dp51",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"disc protrusion"}),
  t("findings","Disc desiccation L4-L5","Loss of T2 signal (desiccation) of the L4-L5 disc.",{mnemonic:"dd45",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"desiccation"}),
  t("findings","Reduced disc height L4-L5","Disc height is reduced at L4-L5.",{mnemonic:"dh45",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"disc height"}),
  t("findings","Mild canal stenosis L4-L5","Mild canal stenosis at L4-L5 without cord compression.",{mnemonic:"cs1",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"canal stenosis"}),
  t("findings","Moderate canal stenosis L4-L5","Moderate canal stenosis at L4-L5.",{mnemonic:"cs2",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"canal stenosis"}),
  t("findings","Severe canal stenosis L4-L5","Severe canal stenosis at L4-L5 with thecal sac compression.",{mnemonic:"cs3",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"critical",conflictGroup:"canal stenosis",impressionSentence:"Severe canal stenosis at L4-L5."}),
  t("findings","Grade 1 spondylolisthesis L4-L5","Grade 1 spondylolisthesis at L4-L5.",{mnemonic:"sl1",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"spondylolisthesis"}),
  t("findings","Grade 2 spondylolisthesis L4-L5","Grade 2 spondylolisthesis at L4-L5.",{mnemonic:"sl2",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"spondylolisthesis"}),
  t("findings","Modic type 1 L4-L5","Modic type 1 endplate changes at L4-L5.",{mnemonic:"m1",scopeModality:"MR",scopeBodyPart:"LS Spine",category:"abnormal",conflictGroup:"endplate"}),
  ...
  t("findings","SDH","Acute subdural hematoma over the right convexity, maximum thickness ___ mm. Mass effect with midline shift of ___ mm to the left.",{mnemonic:"sd",scopeModality:"CT",scopeBodyPart:"Brain",category:"critical",conflictGroup:"subdural hematoma"}),
  t("findings","Normal lungs","Lung fields are clear. No focal consolidation or mass lesion. No pleural effusion.",{mnemonic:"nl",scopeModality:"CT",scopeBodyPart:"Chest",favorite:true,conflictGroup:"pneumothorax",baselineReplaces:"Lung fields are clear. No focal consolidation or mass lesion. No pleural effusion."}),
  t("findings","Pulmonary nodule","Spiculated pulmonary nodule measuring ___ × ___ × ___ cm in the right upper lobe. Surrounding ground-glass opacities. Findings are highly suspicious for malignancy.",{mnemonic:"pn",scopeModality:"CT",scopeBodyPart:"Chest",category:"abnormal",favorite:true,conflictGroup:"pulmonary nodule"}),
  t("findings","Pneumothorax","Tension pneumothorax on the right with mediastinal shift to the left.",{mnemonic:"px",scopeModality:"CT",scopeBodyPart:"Chest",category:"critical",conflictGroup:"pneumothorax"}),
  t("findings","Normal gallbladder","Gallbladder is normal in size and wall thickness. No calculi or sludge. Common bile duct is unremarkable.",{mnemonic:"ng",scopeModality:"US",scopeBodyPart:"Abdomen",favorite:true,conflictGroup:"cholelithiasis",baselineReplaces:"Gallbladder is normal in size and wall thickness. No calculi or sludge. Common bile duct is unremarkable."}),
  t("findings","Gallstones","Multiple echogenic foci with acoustic shadowing in the gallbladder lumen, largest measuring ___ mm, suggestive of cholelithiasis. Gallbladder wall thickness normal.",{mnemonic:"gs",scopeModality:"US",scopeBodyPart:"Abdomen",category:"abnormal",favorite:true,conflictGroup:"cholelithiasis"}),
  t("findings","Renal calculus","Echogenic renal calculus in the {side} kidney with posterior acoustic shadowing.",{mnemonic:"rk",scopeModality:"US",scopeBodyPart:"Abdomen",category:"abnormal",conflictGroup:"renal",properties:"side"}),
  ...
  t("findings","Spiculated mass","Spiculated mass in the right upper outer quadrant measuring ___ × ___ cm with associated skin retraction. Highly suspicious for malignancy.",{mnemonic:"sm",scopeModality:"MG",scopeBodyPart:"Breast",category:"critical",conflictGroup:"spiculated mass"}),
  t("findings","Meniscus tear","Oblique tear of the {side} meniscus.",{mnemonic:"mt",scopeModality:"MR",scopeBodyPart:"Knee",category:"abnormal",conflictGroup:"meniscus",properties:"side"}),
  t("findings","Rotator cuff tear","Full-thickness tear of the {side} rotator cuff.",{mnemonic:"rc",scopeModality:"MR",scopeBodyPart:"Shoulder",category:"abnormal",conflictGroup:"rotator cuff",properties:"side"}),
  t("findings","Hip effusion","Moderate effusion in the {side} hip joint.",{mnemonic:"he",scopeModality:"MR",scopeBodyPart:"Pelvis",category:"abnormal",conflictGroup:"hip",properties:"side"}),
  t("findings","Maxillary sinusitis","Mucosal thickening in the {side} maxillary sinus.",{mnemonic:"ms",scopeModality:"CT",scopeBodyPart:"PNS",category:"abnormal",conflictGroup:"sinus",properties:"side"}),
  ...
  t("impression","BI-RADS 5","BI-RADS 5: Highly suggestive of malignancy. Biopsy mandatory. Surgical referral advised.",{mnemonic:"b5",scopeModality:"MG",scopeBodyPart:"Breast",category:"critical",conflictGroup:"bi-rads"}),
