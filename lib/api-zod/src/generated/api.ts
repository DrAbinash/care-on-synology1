...
export const CreateOrderBody = zod.object({
  ...
  clientRef: zod
    ...
    .optional()
    .describe(
      "Idempotency key — same UUID as sent to \/api\/bills. Prevents duplicate orders when the browser retries a timed-out POST.",
    ),
});
...
export const CreateBillBody = zod.object({
  ...
  clientRef: zod
    ...
    .optional()
    .describe(
      "Idempotency key (UUID v4) — generated by the client before the first attempt. If the server has already processed a bill for this key, it returns the existing bill without creating a duplicate.",
    ),
});
