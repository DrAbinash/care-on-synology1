...
export const STRUCTURED_RULE_DEFINITIONS: RuleDefinition[] = [
  ...
  def({ id: "care.structured.measurement.required.usg.growth", canonicalId: "care.structured.measurement.required.usg.growth", category: "measurement", modalities: ["US"], severity: "warning", executor: "structured.required-measurement", params: {}, requires: ["measurements", "protocolRequiredMeasurements"], provenance: { source: "radiology_protocols.required_measurements (per study)", ref: "radiology_protocols" } }),
  ...
  // ── CT ──
  def({ id: "care.structured.measurement.required.ct.by-protocol", canonicalId: "care.structured.measurement.required.ct.by-protocol", category: "measurement", modalities: ["CT"], severity: "warning", executor: "structured.required-measurement", params: {}, requires: ["measurements", "protocolRequiredMeasurements"], provenance: { source: "radiology_protocols.required_measurements (per study, e.g. CT Brain Plain)", ref: "radiology_protocols" } }),
  ...
  // ── XR ──
  def({ id: "care.structured.measurement.required.xr.by-protocol", canonicalId: "care.structured.measurement.required.xr.by-protocol", category: "measurement", modalities: ["XR"], severity: "warning", executor: "structured.required-measurement", params: {}, requires: ["measurements", "protocolRequiredMeasurements"], provenance: { source: "radiology_protocols.required_measurements (per study, e.g. X-Ray Chest PA)", ref: "radiology_protocols" } }),
  ...
  def({ id: "care.structured.completeness.section.coverage", canonicalId: "care.structured.completeness.section.coverage", category: "completeness", modalities: "*", severity: "warning", executor: "structured.required-section", params: { excludeNotApplicable: true }, requires: ["template", "coveredSections", "knowledgePack"], provenance: { source: "template required sections vs documented (covered) sections", ref: "report section presence" } }),
];
